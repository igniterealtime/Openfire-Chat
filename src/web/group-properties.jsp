...
<%@ page import="org.jivesoftware.openfire.XMPPServer,
        org.jivesoftware.openfire.plugin.rawpropertyeditor.RawPropertyEditor,
        org.jivesoftware.util.ParamUtils,org.jivesoftware.openfire.*,
        java.util.HashMap,
        org.apache.commons.lang3.StringUtils,           
        java.util.Map,org.jivesoftware.util.*,
...
<%
    ...
    if (!group.isEmpty() && group != null) {
        try {
            properties = RawPropertyEditor.self.getGroupProperties(group);
        } catch (Exception e) {
        }
    }
    ...
    if (request.getParameter("save") != null && request.getParameter("save").equals("true")) {
        try {
            ...
            RawPropertyEditor.self.addGroupProperties(group, propname2, propvalue2);
            properties = RawPropertyEditor.self.getGroupProperties(group);
        } catch (Exception e) {
    ...
    if (request.getParameter("delete") != null && request.getParameter("delete").equals("true")) {
        try {
            RawPropertyEditor.self.deleteGroupProperties(group, propname2);
            properties = RawPropertyEditor.self.getGroupProperties(group);
        } catch (Exception e) {
...
<meta name="subPageID" content="group-properties-plugin" />
...
<body onload="loaded();">
    ...
    <form action="group-properties.jsp<%="?group=" + group%>"
                    ...
                    <%
                        if (properties != null
                            ...
                            for (Map.Entry<String, String> property : properties.entrySet()) {
                                ...
                                String propnameES = StringUtils.replace(org.jivesoftware.util.StringUtils.escapeHTMLTags(propname), "'", "''");
                                String propvalueES = StringUtils.replace(org.jivesoftware.util.StringUtils.escapeHTMLTags(propvalue), "'", "''");
                    %>
