...
<%@ page import="org.jivesoftware.openfire.plugin.rest.EmailListener,
    ...
    if (test && errors.isEmpty()) {
        ...
        if (save) {
            if (errors.isEmpty()) {
                ...
                response.sendRedirect("ofchat-email-listener.jsp?success=true");
            }
        }
...
<html>
    <head>
        ...
        <meta name="pageID" content="ofchat-email-listener"/>
    </head>
    <body>

<p>
    <fmt:message key="ofmeet.email.listener.description" />
</p>
