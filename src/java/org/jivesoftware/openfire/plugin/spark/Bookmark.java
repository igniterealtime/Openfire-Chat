...
public class Bookmark implements Serializable {
     ...
     */
    public Bookmark(Type type, String name, String value) throws ServiceException {
        this.type = type;
        this.name = name;
        this.value = value;
     ...
     * @param value the value of the bookmark.
     */
    public Bookmark(Type type, String name, String value, Collection<String> users, Collection<String> groups) throws ServiceException {
        this.type = type;
        this.name = name;
        this.value = value;
        this.users = users;
     ...
     */
    private void insertIntoDb() throws ServiceException {
    ...
    private void insertBookmarkPermission(int type, String name) throws ServiceException {
        Connection con = null;
        boolean abortTransaction = false;
        try {
            con = DbConnectionManager.getTransactionConnection();
    ...
    private void deleteBookmarkPermissions() throws ServiceException {
        Connection con = null;
        boolean abortTransaction = false;
        try {
            con = DbConnectionManager.getTransactionConnection();
