...
<%
    ...
    {               
         List<String> callsLines = RESTServicePlugin.getInstance().sendFWCommand("show calls as xml");
...
%>
            ...
            <td width="1%" align="center" style="border-right:1px #ccc solid;">
                <a href="clear-call.jsp?callid=<%= URLEncoder.encode(uuid, "UTF-8") %>" title="Clear Call"><img src="images/delete-16x16.gif" width="16" height="16" border="0" alt=""></a>
            </td>       
            </tr>
<%
            count++;
